...
double* calc_all_solutions(double q1, double q2, double q3, double q4, double q5) {
    ...
    // Common denominators
    const long double q1_sq = (long double)q1 * q1;
    const long double q4_sq = (long double)q4 * q4;
    ...
    const complex<long double> term2_a =
        2.0 * (pow(q2, 2) + 2 * q1 * q3 - q4_sq + pow(q5, 2)) / (3.0 * denom);
    ...
    const complex<long double> cubic_num =
        -12.0 * B * A + 12.0 * denom * (pow(q3, 2) - pow(q5, 2)) + C_sq;

    const complex<long double> big_term =
        108.0 * denom * B_sq + 108.0 * A_sq * (pow(q3, 2) - pow(q5, 2)) -
        36.0 * B * A * C - 72.0 * denom * (pow(q3, 2) - pow(q5, 2)) * C + 2.0 * C_cu;

    const complex<long double> inner_sqrt =
        sqrt(-4.0 * pow(cubic_num, 3) + pow(big_term, 2));
    const complex<long double> cubic_root = pow(big_term + inner_sqrt, 1.0 / 3.0);

    const complex<long double> pow2_1_3 = pow(2.0, 1.0 / 3.0);
    const complex<long double> term3_a =
        pow2_1_3 * cubic_num / (3.0 * denom * cubic_root);
    ...
    const complex<long double> diff_term =
        ((-8.0 * A * A_sq) / pow(denom, 3) + 16.0 * (-B) / denom +
         8.0 * A * C / pow(denom, 2)) /
        (4.0 * first_sqrt);
    ...
    const double acos1 = arccos(args[0]);
    const double acos2 = arccos(args[1]);
    const double acos3 = arccos(args[2]);
    const double acos4 = arccos(args[3]);
...
double soln1(complex<double> q1in, complex<double> q2in, complex<double> q3in,
             complex<double> q4in, complex<double> q5in) {
    ...
    double out = -arccos(
        -0.5 * (q1 * q2 + q4 * q5) / (pow(q1, 2) + pow(q4, 2)) -
        sqrt(
            pow(q1 * q2 + q4 * q5, 2) / pow(pow(q1, 2) + pow(q4, 2), 2) -
            (2 * (pow(q2, 2) + 2 * q1 * q3 - pow(q4, 2) + pow(q5, 2))) /
                (3. * (pow(q1, 2) + pow(q4, 2))) +
            (pow(2, (1. / 3.)) *
             (-12 * (q2 * q3 - q4 * q5) * (q1 * q2 + q4 * q5) +
                ...
                (3. * (pow(q1, 2) + pow(q4, 2)) *
                 pow(108 * (pow(q1, 2) + pow(q4, 2)) * pow(q2 * q3 - q4 * q5, 2) +
                         ...
                         72 * (pow(q1, 2) + pow(q4, 2)) * (pow(q3, 2) - pow(q5, 2)) *
                             (pow(q2, 2) + 2 * q1 * q3 - pow(q4, 2) + pow(q5, 2)) +
                         2 * pow(pow(q2, 2) + 2 * q1 * q3 - pow(q4, 2) + pow(q5, 2),
                                 3) +
                         sqrt(-4 * pow(-12 * (q2 * q3 - q4 * q5) * (q1 * q2 + q4 * q5) +
                                           12 * (pow(q1, 2) + pow(q4, 2)) *
                                               (pow(q3, 2) - pow(q5, 2)) +
                                           pow(pow(q2, 2) + 2 * q1 * q3 - pow(q4, 2) +
                                                   pow(q5, 2),
                                               2),
                                       3) +
                              pow(108 * (pow(q1, 2) + pow(q4, 2)) *
                                          pow(q2 * q3 - q4 * q5, 2) +
                                      108 * pow(q1 * q2 + q4 * q5, 2) *
                                          (pow(q3, 2) - pow(q5, 2)) -
                                      36 * (q2 * q3 - q4 * q5) * (q1 * q2 + q4 * q5) *
                                          (pow(q2, 2) + 2 * q1 * q3 - pow(q4, 2) +
                                           pow(q5, 2)) -
                                      72 * (pow(q1, 2) + pow(q4, 2)) *
                                          (pow(q3, 2) - pow(q5, 2)) *
                                          (pow(q2, 2) + 2 * q1 * q3 - pow(q4, 2) +
                                           pow(q5, 2)) +
                                      2 * pow(pow(q2, 2) + 2 * q1 * q3 - pow(q4, 2) +
                                                  pow(q5, 2),
                                              3),
                                  2)),
                     (1. / 3.))) +
            ...
            2. -
        sqrt(
            (2 * pow(q1 * q2 + q4 * q5, 2)) / pow(pow(q1, 2) + pow(q4, 2), 2) -
            (4 * (pow(q2, 2) + 2 * q1 * q3 - pow(q4, 2) + pow(q5, 2))) /
                (3. * (pow(q1, 2) + pow(q4, 2))) -
            (pow(2, (1. / 3.)) *
             (-12 * (q2 * q3 - q4 * q5) * (q1 * q2 + q4 * q5) +
              12 * (pow(q1, 2) + pow(q4, 2)) * (pow(q3, 2) - pow(q5, 2)) +
                         ...
                         (3. * (pow(q1, 2) + pow(q4, 2)) *
                          pow(108 * (pow(q1, 2) + pow(q4, 2)) *
                                  ...
                                  2 * pow(pow(q2, 2) + 2 * q1 * q3 - pow(q4, 2) +
                                              pow(q5, 2),
                                          3) +
                                  sqrt(-4 * pow(-12 * (q2 * q3 - q4 * q5) *
                                                        (q1 * q2 + q4 * q5) +
                                                    12 * (pow(q1, 2) + pow(q4, 2)) *
                                                        (pow(q3, 2) - pow(q5, 2)) +
                                                    pow(pow(q2, 2) + 2 * q1 * q3 -
                                                            pow(q4, 2) + pow(q5, 2),
                                                        2),
                                                3) +
                                       pow(108 * (pow(q1, 2) + pow(q4, 2)) *
...
double soln2(complex<double> q1in, complex<double> q2in, complex<double> q3in,
             complex<double> q4in, complex<double> q5in) {
    complex<long double> q1(real(q1in), imag(q1in));
    complex<long double> q2(real(q2in), imag(q2in));
    complex<long double> q3(real(q3in), imag(q3in));
...
double soln3(complex<double> q1in, complex<double> q2in, complex<double> q3in,
             complex<double> q4in, complex<double> q5in) {
    complex<long double> q1(real(q1in), imag(q1in));
    complex<long double> q2(real(q2in), imag(q2in));
    complex<long double> q3(real(q3in), imag(q3in));
...
double soln4(complex<double> q1in, complex<double> q2in, complex<double> q3in,
             complex<double> q4in, complex<double> q5in) {
    complex<long double> q1(real(q1in), imag(q1in));
    complex<long double> q2(real(q2in), imag(q2in));
    complex<long double> q3(real(q3in), imag(q3in));
...
double soln5(complex<double> q1in, complex<double> q2in, complex<double> q3in,
             complex<double> q4in, complex<double> q5in) {
    complex<long double> q1(real(q1in), imag(q1in));
    complex<long double> q2(real(q2in), imag(q2in));
    complex<long double> q3(real(q3in), imag(q3in));
...
double soln6(complex<double> q1in, complex<double> q2in, complex<double> q3in,
             complex<double> q4in, complex<double> q5in) {
    complex<long double> q1(real(q1in), imag(q1in));
    complex<long double> q2(real(q2in), imag(q2in));
    complex<long double> q3(real(q3in), imag(q3in));
...
double soln7(complex<double> q1in, complex<double> q2in, complex<double> q3in,
             complex<double> q4in, complex<double> q5in) {
    complex<long double> q1(real(q1in), imag(q1in));
    complex<long double> q2(real(q2in), imag(q2in));
    complex<long double> q3(real(q3in), imag(q3in));
...
double soln8(complex<double> q1in, complex<double> q2in, complex<double> q3in,
             complex<double> q4in, complex<double> q5in) {
    complex<long double> q1(real(q1in), imag(q1in));
    complex<long double> q2(real(q2in), imag(q2in));
    complex<long double> q3(real(q3in), imag(q3in));
...
//     // cout << "Time taken to calculate each solution individually 100000 times: " <<
...
//     cout << "Time taken to calculate vector solution 100000 times: " << time_taken2
//     << " seconds" << endl;
