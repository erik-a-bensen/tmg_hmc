...
def soln1(q1: float, q2: float, q3: float, q4: float, q5: float) -> float:
    ...
    """
    return -arccos(
        -0.5 * (q1 * q2 + q4 * q5) / (q1**2 + q4**2)
        - sqrt(
            (q1 * q2 + q4 * q5) ** 2 / (q1**2 + q4**2) ** 2
            - (2 * (q2**2 + 2 * q1 * q3 - q4**2 + q5**2)) / (3.0 * (q1**2 + q4**2))
            + (
                2 ** (1.0 / 3)
                * (
                    -12 * (q2 * q3 - q4 * q5) * (q1 * q2 + q4 * q5)
                    + 12 * (q1**2 + q4**2) * (q3**2 - q5**2)
                    + (q2**2 + 2 * q1 * q3 - q4**2 + q5**2) ** 2
                )
            )
            / (
                3.0
            ...
            ** (1.0 / 3)
            / (3.0 * 2 ** (1.0 / 3) * (q1**2 + q4**2))
        )
        / 2.0
        - sqrt(
            (2 * (q1 * q2 + q4 * q5) ** 2) / (q1**2 + q4**2) ** 2
            - (4 * (q2**2 + 2 * q1 * q3 - q4**2 + q5**2)) / (3.0 * (q1**2 + q4**2))
            - (
                2 ** (1.0 / 3)
                * (
                    -12 * (q2 * q3 - q4 * q5) * (q1 * q2 + q4 * q5)
            ...
            ** (1.0 / 3)
            / (3.0 * 2 ** (1.0 / 3) * (q1**2 + q4**2))
            - (
                (-8 * (q1 * q2 + q4 * q5) ** 3) / (q1**2 + q4**2) ** 3
                + (16 * (-(q2 * q3) + q4 * q5)) / (q1**2 + q4**2)
                + (8 * (q1 * q2 + q4 * q5) * (q2**2 + 2 * q1 * q3 - q4**2 + q5**2))
                / (q1**2 + q4**2) ** 2
            )
            / (
                4.0
